<div class="found-an-error">
    <form action="#" id="suggest-a-correction-form" method="post" novalidate="novalidate">
        ...
        <div class="suggestion-form-wrapper">
            ...
            <div class="form-field-group">
                <label for="referenceDetails" id="reference-details-label"> Have you seen this error elsewhere? Please
        ...
        <div class="suggestion-form-wrapper">
            ...
            <div class="form-field-group">
                ...
                <div class="small-spacer-below">
                    ...
                    <input data-val="true" data-val-email="Email not valid" id="userEmail" name="UserEmail" type="text"
                           value=""></div>
            </div>
        ...
        <input id="Hash" name="Hash" type="hidden" value=""><input id="DocReference" name="DocReference" type="hidden"
